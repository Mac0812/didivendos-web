    ...
    <script>
      ...
      function loadCompanies() {
        fetch("php/get_companies.php")
          ...
          .then(data => {
            const empresaSelect = document.getElementById("event-empresa");
            empresaSelect.innerHTML = ""; // Limpiar opciones existentes
            data.forEach(company => {
              const option = document.createElement("option");
              option.value = company.nombre; // Usa el ID de la empresa como valor
              option.textContent = company.nombre; // Usa el nombre de la empresa como texto
