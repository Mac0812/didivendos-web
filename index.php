...
<head>
  ...
  <style>
    ...
    .accept-button {
      ...
      border: none;
      border-radius: 5px;
      box-shadow: 0 5px 15px rgba(62, 243, 62, 0.4);
      cursor: pointer;
    ...
    .notificacion {
      padding: 15px;
      border: 2px solid rgb(166, 228, 246);
      margin: 5px;
      background-color: #f0f0f0;
    }
    ...
    <nav id="sidebar" class="sidebar js-sidebar">
      <div class="sidebar-content js-simplebar">
        <a class="sidebar-brand" href="index.php">
          <img src="static/assets/Iconos/logoNav.png" alt="+Dividendos" class="align-middle" width="70" height="70">
        </a>
          ...
          <script>
            ...
            function aceptarNotificaciones() {
              if (confirm('¿Está seguro de que desea recibir notificaciones?')) {
                ...
                xhr.open('POST', 'static/php/aceptar_notificaciones.php', true);
                ...
                xhr.send('aceptar_notificaciones=1&id=id'); // Enviar los datos necesarios
              }
            }
