  ...
  <div class="wrapper">
    ...
    <div class="main">
                <nav class="navbar navbar-expand navbar-light navbar-bg">
                  <a class="iconoo" href="index.php">
                    <img src="/static/assets/Iconos/+dN.svg" alt="+Dividendos" class="align-middle" width="70" height="70">
                </a>
                <ul class="nav-links">
                 <li class="un"><a href="#"> Calendario</a></li>
                 <li class="do"><a href="#"> Comunidades</a></li>
                 <li class="te"><a href="#">Educacional</a></li>
                </ul>
